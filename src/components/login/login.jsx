...
const Login = () => {
  return (
    <div>
      <div className="flex-col justify-center items-center min-h-screen bg-[#F9EFDB]">
        <Head>
          <title>Login</title>
        </Head>
        <div className="pt-40 flex flex-col md:flex-row w-full max-w-screen-xl mx-auto">
        ...
        <div className="flex mt-10 justify-end mr-52">
          <button className="border-2 rounded-xl border-stone-500 bg-[#4285F4] text-white px-6 md:px-32 py-3 mb-4 md:mb-6 hover:bg-[#0F9D58] focus:outline-none">
