    ...
    <div>
      <nav className="bg-[#F9EFDB]  w-full md:static md:text-sm md:border-none">
        <div className="items-center px-4 max-w-screen-xl mx-auto md:flex ">
          ...
          <div
            className={`flex-1 pb-3 mt-2 border-gray 400 border-t md:border-0 md:block md:pb-0 md:mt-0 ${
              state ? "block" : "hidden"
            }`}
          >
        ...
        <button className="flex items-center bg-[#F9EFDB] border-black border rounded-full px-4 py-2">
          <span className="text-black mr-2">Sign In</span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6"
            viewBox="0 0 20 20"
    ...
    <Link href={path}>
      <p
        className={`text-gray-700 text-sm font-semibold ${
          currentPath === path ? "border-b-2 border-blue-500" : ""
        } ${className || ""}`}
      >
        {label}
      </p>
